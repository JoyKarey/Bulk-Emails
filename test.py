...
def send_emails_with_attachments_from_excel(excel_path, pdf_dir, subject_template, signature_image_path, cc_addresses=None):
    ...
    for _, row in df.iterrows():
        ...
        mail.HTMLBody = (
            ...
            f"<p style='font-family:Calibri; font-size:11pt; color:black;'>Attached find the AUGUST 2024 deduction schedule for your further action.</p><br>"
            f"<p style='font-family:Calibri; font-size:11pt; color:black;'>Kindly acknowledge receipt.</p><br>"
            f"<p style='font-family:Calibri; font-size:11pt; color:black;'>Have a pleasant day</p><br>"
            f"<p style='font-family:Times New Roman; font-size:12pt; color:#7030A0; font-weight:bold;'>Regards,</p>"
            f"<p style='font-family:Times New Roman; font-size:12pt; color:#7030A0; font-weight:bold;'>Joy Wangari</p>"
            f"<p style='font-family:Times New Roman; font-size:12pt; color:#7030A0; font-weight:bold;'>Data Office</p>"
            f"<p style='font-family:Times New Roman; font-size:12pt; color:#7030A0; font-weight:bold;'>Newfortis Sacco, P.O BOX 1939-10100, Nyeri, Kenya</p>"
            f"<p style='font-family:Times New Roman; font-size:12pt; color:#7030A0; font-weight:bold;'>Office: +254 (0) 735 249 343 |</p>"
            f"<p style='font-family:Times New Roman; font-size:12pt; color:#7030A0; font-weight:bold;'>Email: <a href='mailto:jwangari@newfortissacco.coop'>jwangari@newfortissacco.coop</a></p>"
...
subject_template = "NEWFORTIS SACCO AUGUST 2024 DATA"

# Paths to the Excel file with institution names and emails, PDF directory, and signature image
excel_path = r'C:\Users\JWANGARI\Desktop\PYTHON\Test.xlsx'
pdf_dir = r'C:\Users\JWANGARI\Desktop\PYTHON\SCANS'
signature_image_path = r'C:\Users\JWANGARI\Desktop\PYTHON\sign.png'
cc_addresses = ['Joy Wangari <joykamau32@gmail.com>']
